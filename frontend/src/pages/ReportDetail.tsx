  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-semibold text-slate-800">月报 · {displayLabel}</h1>
      ...
      <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
        <div className="mb-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-medium text-slate-700">月度概览</h2>
          </div>
          <button
        ...
        <div className="grid grid-cols-4 gap-6">
          ...
          <div>
            ...
            <p className="mt-1 flex items-center gap-1 font-mono text-xl font-semibold text-slate-800">
        ...
        <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
          <div className="mb-4 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h2 className="font-medium text-slate-700">消费结构</h2>
            </div>
            <button
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={item.name} className="flex items-center gap-3">
                <span className="w-12 text-sm text-slate-600">{item.name}</span>
                ...
                <span className="w-16 text-right font-mono text-sm text-slate-600">
        ...
        <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
          <div className="mb-4 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h2 className="font-medium text-slate-700">现金流</h2>
            </div>
            <button
              onClick={() => navigate('/ledger')}
              className="text-xs text-emerald-600 hover:text-emerald-700"
      ...
      <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
        <div className="mb-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-medium text-slate-700">投资概览</h2>
          </div>
          <button
        ...
        <div className="grid grid-cols-3 gap-6">
          <div>
            ...
            <p className="mt-1 font-mono text-lg font-semibold text-slate-800">¥ 8,226.10</p>
          </div>
          <div>
            <p className="text-sm text-slate-400">本月赎回</p>
            <p className="mt-1 font-mono text-lg font-semibold text-slate-800">¥ 737.40</p>
          </div>
          <div>
