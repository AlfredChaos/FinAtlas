        ...
        {metrics.map((m) => {
          ...
          return (
            <button
              ...
              className="flex items-center gap-4 rounded-lg border border-slate-200 bg-white p-5 text-left shadow-sm transition-shadow hover:shadow-md"
            >
              <div
                className={cn(
                  'flex h-10 w-10 items-center justify-center rounded-lg',
                  m.up ? 'bg-emerald-50 text-emerald-600' : 'bg-slate-50 text-slate-500',
                )}
              >
              ...
              <div className="flex-1">
                ...
                <p className="font-mono text-lg font-semibold text-slate-800">{m.value}</p>
              </div>
              {m.change && (
                <span
                  className={cn(
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
          <div className="mb-4 flex items-center justify-between">
            <h2 className="font-medium text-slate-700">现金流趋势</h2>
            <div className="flex gap-2">
              <button className="rounded-md bg-slate-100 px-2.5 py-1 text-xs text-slate-600">
                近6月
              </button>
        ...
        <div className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
          <div className="mb-4 flex items-center justify-between">
            <h2 className="font-medium text-slate-700">最近导入</h2>
            <button
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
          <div className="mb-4 flex items-center gap-2">
            ...
            <h2 className="font-medium text-slate-700">异常支出提醒</h2>
          </div>
          <div className="space-y-3">
            {[
        ...
        <div className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
          <div className="mb-4 flex items-center justify-between">
            <h2 className="font-medium text-slate-700">待分类交易</h2>
        ...
        >
          <div className="mb-4 flex items-center gap-2">
            ...
            <h2 className="font-medium text-slate-700">推荐问题</h2>
          </div>
          <div className="space-y-2">
            {[
              '本月消费与上月相比如何？',
              ...
              <div
                key={i}
                className="rounded-md border border-emerald-100 bg-emerald-50/50 px-3 py-2 text-sm text-emerald-700"
              >
                {q}
              </div>
            ))}
