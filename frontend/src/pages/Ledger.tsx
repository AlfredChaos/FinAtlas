...
export default function Ledger() {
  ...
  return (
    <div className="space-y-6">
      {/* 页面标题 */}
      <div>
        <h1 className="text-2xl font-semibold text-slate-900">交易台账</h1>
              ...
              {mockTransactions.map((tx) => (
                <tr
                  ...
                  className={cn(
                    ...
                    selectedRow === tx.id && 'bg-emerald-50',
                  )}
                >
                  <td className="px-4 py-2.5 text-sm text-slate-500">{tx.date}</td>
                  <td className="px-4 py-2.5 text-sm text-slate-500">{tx.account}</td>
        ...
        {drawerOpen && selectedTx && (
          <GlassCard cornerRadius={16} padding="p-5" className="w-72 flex-shrink-0">
            <div className="mb-4 flex items-center justify-between">
              <h3 className="font-medium text-slate-900">证据链</h3>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-1.5 rounded-md bg-slate-50 px-2.5 py-2">
                  ...
                  <span className="text-xs font-mono text-slate-500">{selectedTx.evidence}</span>
                </div>
              </div>
              <div>
